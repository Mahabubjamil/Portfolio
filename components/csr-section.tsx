...
export function CSRSection() {
  ...
  return (
    <section
      id="csr"
      className="py-20 bg-gradient-to-b from-[#1E1E1E] to-[#2C2C2C]"
    >
      <div className="container mx-auto px-4">
        ...
        <div className="max-w-4xl mx-auto">
          <Card
            className={`p-8 bg-gradient-to-br from-[#232323] to-[#2E2E2E] border-[#00D4FF]/20 ${
          ...
          >
            <div className="text-center space-y-6">
              ...
              <p className="text-lg text-white leading-relaxed max-w-3xl mx-auto">
                ...
                Codeinnovior, empowering kids and students with coding, design,
              ...
              <div className="grid grid-cols-3 gap-6 pt-8">
                <div className="text-center">
                  ...
                  <div className="text-3xl font-poppins font-bold text-[#00D4FF]">
                    50+
                  </div>
                ...
                <div className="text-center">
                  ...
                  <div className="text-3xl font-poppins font-bold text-[#00FF88]">
                    10+
                  </div>
              ...
              >
                <Button
                  className="bg-[#00D4FF] text-white font-montserrat px-8 py-3 rounded-xl mt-8 
  transition-all duration-300 ease-in-out 
  hover:bg-[#00D4FF]/90 hover:scale-105 hover:shadow-[0_8px_20px_rgba(0,212,255,0.5)]"
                >
